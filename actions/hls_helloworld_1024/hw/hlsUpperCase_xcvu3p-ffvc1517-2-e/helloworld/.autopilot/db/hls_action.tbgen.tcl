...
set C_modelArgList {
	{ host_mem int 1024 regular {axi_master 2}  }
	{ din_gmem_V int 64 regular {axi_slave 0}  }
	{ dout_gmem_V int 64 regular {axi_slave 0}  }
	{ act_reg int 992 regular {axi_slave 2}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "host_mem", "interface" : "axi_master", "bitwidth" : 1024, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":1023,"cElement": [{"cName": "din_gmem.V","cData": "uint1024","bit_use": { "low": 0,"up": 1023},"offset": { "type": "dynamic","port_name": "din_gmem_V","bundle": "ctrl_reg"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 1023,"step" : 1}]},{"cName": "dout_gmem.V","cData": "uint1024","bit_use": { "low": 0,"up": 1023},"offset": { "type": "dynamic","port_name": "dout_gmem_V","bundle": "ctrl_reg"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 1023,"step" : 1}]}]}]} , 
...
set portList { 
	...
	{ m_axi_host_mem_WDATA sc_out sc_lv 1024 signal 0 } 
	{ m_axi_host_mem_WSTRB sc_out sc_lv 128 signal 0 } 
	...
	{ m_axi_host_mem_RDATA sc_in sc_lv 1024 signal 0 } 
...
set NewPortList {[ 
	...
	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ctrl_reg", "role": "interrupt" } }, 
 	...
 	{ "name": "m_axi_host_mem_WDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "host_mem", "role": "WDATA" }} , 
 	{ "name": "m_axi_host_mem_WSTRB", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "host_mem", "role": "WSTRB" }} , 
 	...
 	{ "name": "m_axi_host_mem_RDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "host_mem", "role": "RDATA" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"WaitState" : [
			{"State" : "ap_ST_fsm_state2", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_process_action_fu_103"}],
		"Port" : [
			{"Name" : "host_mem", "Type" : "MAXI", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_process_action_fu_103", "Port" : "din_gmem_V"}]},
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_process_action_fu_103", "Parent" : "0", "Child" : ["4"],
		"CDFG" : "process_action",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_process_action_fu_103.text_U", "Parent" : "3"}]}


set ArgLastReadFirstWriteLatency {
	hls_action {
		host_mem {Type IO LastRead 140 FirstWrite 139}
		din_gmem_V {Type I LastRead 0 FirstWrite -1}
		dout_gmem_V {Type I LastRead 0 FirstWrite -1}
		act_reg {Type IO LastRead 0 FirstWrite 0}}
	process_action {
		din_gmem_V {Type IO LastRead 140 FirstWrite 139}
...
set Spec2ImplPortList { 
	host_mem { m_axi {  { m_axi_host_mem_AWVALID VALID 1 1 }  { m_axi_host_mem_AWREADY READY 0 1 }  { m_axi_host_mem_AWADDR ADDR 1 64 }  { m_axi_host_mem_AWID ID 1 1 }  { m_axi_host_mem_AWLEN LEN 1 8 }  { m_axi_host_mem_AWSIZE SIZE 1 3 }  { m_axi_host_mem_AWBURST BURST 1 2 }  { m_axi_host_mem_AWLOCK LOCK 1 2 }  { m_axi_host_mem_AWCACHE CACHE 1 4 }  { m_axi_host_mem_AWPROT PROT 1 3 }  { m_axi_host_mem_AWQOS QOS 1 4 }  { m_axi_host_mem_AWREGION REGION 1 4 }  { m_axi_host_mem_AWUSER USER 1 1 }  { m_axi_host_mem_WVALID VALID 1 1 }  { m_axi_host_mem_WREADY READY 0 1 }  { m_axi_host_mem_WDATA DATA 1 1024 }  { m_axi_host_mem_WSTRB STRB 1 128 }  { m_axi_host_mem_WLAST LAST 1 1 }  { m_axi_host_mem_WID ID 1 1 }  { m_axi_host_mem_WUSER USER 1 1 }  { m_axi_host_mem_ARVALID VALID 1 1 }  { m_axi_host_mem_ARREADY READY 0 1 }  { m_axi_host_mem_ARADDR ADDR 1 64 }  { m_axi_host_mem_ARID ID 1 1 }  { m_axi_host_mem_ARLEN LEN 1 8 }  { m_axi_host_mem_ARSIZE SIZE 1 3 }  { m_axi_host_mem_ARBURST BURST 1 2 }  { m_axi_host_mem_ARLOCK LOCK 1 2 }  { m_axi_host_mem_ARCACHE CACHE 1 4 }  { m_axi_host_mem_ARPROT PROT 1 3 }  { m_axi_host_mem_ARQOS QOS 1 4 }  { m_axi_host_mem_ARREGION REGION 1 4 }  { m_axi_host_mem_ARUSER USER 1 1 }  { m_axi_host_mem_RVALID VALID 0 1 }  { m_axi_host_mem_RREADY READY 1 1 }  { m_axi_host_mem_RDATA DATA 0 1024 }  { m_axi_host_mem_RLAST LAST 0 1 }  { m_axi_host_mem_RID ID 0 1 }  { m_axi_host_mem_RUSER USER 0 1 }  { m_axi_host_mem_RRESP RESP 0 2 }  { m_axi_host_mem_BVALID VALID 0 1 }  { m_axi_host_mem_BREADY READY 1 1 }  { m_axi_host_mem_BRESP RESP 0 2 }  { m_axi_host_mem_BID ID 0 1 }  { m_axi_host_mem_BUSER USER 0 1 } } }
}
