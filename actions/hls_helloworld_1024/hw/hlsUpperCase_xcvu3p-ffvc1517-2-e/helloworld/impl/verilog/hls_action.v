...
(* CORE_GENERATION_INFO="hls_action,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xcvu3p-ffvc1517-2-e,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.375000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=115,HLS_SYN_DSP=0,HLS_SYN_FF=7729,HLS_SYN_LUT=9295,HLS_VERSION=2019_2}" *)
...
parameter C_M_AXI_HOST_MEM_WSTRB_WIDTH = (1024 / 8);
...
reg   [56:0] dout_gmem_V3_reg_182;
reg   [56:0] din_gmem_V1_reg_187;
reg   [63:0] act_reg_Data_in_addr_reg_192;
reg   [31:0] act_reg_Data_in_size_reg_197;
reg   [63:0] act_reg_Data_out_add_reg_202;
wire    grp_process_action_fu_103_ap_start;
wire    grp_process_action_fu_103_ap_done;
wire    grp_process_action_fu_103_ap_idle;
wire    grp_process_action_fu_103_ap_ready;
wire    grp_process_action_fu_103_m_axi_din_gmem_V_AWVALID;
wire   [63:0] grp_process_action_fu_103_m_axi_din_gmem_V_AWADDR;
wire   [0:0] grp_process_action_fu_103_m_axi_din_gmem_V_AWID;
wire   [31:0] grp_process_action_fu_103_m_axi_din_gmem_V_AWLEN;
wire   [2:0] grp_process_action_fu_103_m_axi_din_gmem_V_AWSIZE;
wire   [1:0] grp_process_action_fu_103_m_axi_din_gmem_V_AWBURST;
wire   [1:0] grp_process_action_fu_103_m_axi_din_gmem_V_AWLOCK;
wire   [3:0] grp_process_action_fu_103_m_axi_din_gmem_V_AWCACHE;
wire   [2:0] grp_process_action_fu_103_m_axi_din_gmem_V_AWPROT;
wire   [3:0] grp_process_action_fu_103_m_axi_din_gmem_V_AWQOS;
wire   [3:0] grp_process_action_fu_103_m_axi_din_gmem_V_AWREGION;
wire   [0:0] grp_process_action_fu_103_m_axi_din_gmem_V_AWUSER;
wire    grp_process_action_fu_103_m_axi_din_gmem_V_WVALID;
wire   [1023:0] grp_process_action_fu_103_m_axi_din_gmem_V_WDATA;
wire   [127:0] grp_process_action_fu_103_m_axi_din_gmem_V_WSTRB;
wire    grp_process_action_fu_103_m_axi_din_gmem_V_WLAST;
wire   [0:0] grp_process_action_fu_103_m_axi_din_gmem_V_WID;
wire   [0:0] grp_process_action_fu_103_m_axi_din_gmem_V_WUSER;
wire    grp_process_action_fu_103_m_axi_din_gmem_V_ARVALID;
wire   [63:0] grp_process_action_fu_103_m_axi_din_gmem_V_ARADDR;
wire   [0:0] grp_process_action_fu_103_m_axi_din_gmem_V_ARID;
wire   [31:0] grp_process_action_fu_103_m_axi_din_gmem_V_ARLEN;
wire   [2:0] grp_process_action_fu_103_m_axi_din_gmem_V_ARSIZE;
wire   [1:0] grp_process_action_fu_103_m_axi_din_gmem_V_ARBURST;
wire   [1:0] grp_process_action_fu_103_m_axi_din_gmem_V_ARLOCK;
wire   [3:0] grp_process_action_fu_103_m_axi_din_gmem_V_ARCACHE;
wire   [2:0] grp_process_action_fu_103_m_axi_din_gmem_V_ARPROT;
wire   [3:0] grp_process_action_fu_103_m_axi_din_gmem_V_ARQOS;
wire   [3:0] grp_process_action_fu_103_m_axi_din_gmem_V_ARREGION;
wire   [0:0] grp_process_action_fu_103_m_axi_din_gmem_V_ARUSER;
wire    grp_process_action_fu_103_m_axi_din_gmem_V_RREADY;
wire    grp_process_action_fu_103_m_axi_din_gmem_V_BREADY;
reg    grp_process_action_fu_103_ap_start_reg;
...
initial begin
#0 ap_CS_fsm = 2'd1;
#0 grp_process_action_fu_103_ap_start_reg = 1'b0;
end
...
process_action grp_process_action_fu_103(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_process_action_fu_103_ap_start_reg <= 1'b0;
    end else begin
        if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
            grp_process_action_fu_103_ap_start_reg <= 1'b1;
        end else if ((grp_process_action_fu_103_ap_ready == 1'b1)) begin
            grp_process_action_fu_103_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        act_reg_Data_in_addr_reg_192 <= {{act_reg_i[191:128]}};
        act_reg_Data_in_size_reg_197 <= {{act_reg_i[223:192]}};
        act_reg_Data_out_add_reg_202 <= {{act_reg_i[319:256]}};
        din_gmem_V1_reg_187 <= {{din_gmem_V[63:7]}};
        dout_gmem_V3_reg_182 <= {{dout_gmem_V[63:7]}};
    end
end
...
always @ (*) begin
    if (((grp_process_action_fu_103_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
assign act_reg_o = {{act_reg_i[991:64]}, {32'd258}, {act_reg_i[31:0]}};
...
assign grp_process_action_fu_103_ap_start = grp_process_action_fu_103_ap_start_reg;
